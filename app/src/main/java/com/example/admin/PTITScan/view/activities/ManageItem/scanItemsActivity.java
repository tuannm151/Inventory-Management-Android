...
import com.example.admin.PTITScan.view.activities.ManageItem.ScanCodeActivitysearch;
...
public class scanItemsActivity extends AppCompatActivity {
    ...
    public void firebasesearch(String searchtext){
        ...
        FirebaseRecyclerAdapter<Item, UsersViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<Item, UsersViewHolder>
                (  Item.class,
        ...
        {
            @Override
            protected void populateViewHolder(UsersViewHolder viewHolder, Item model, int position){
